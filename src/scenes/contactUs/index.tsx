...
const ContactUs = ({ setSelectedPage }: Props) => {
  ...
  return (
    <section id="conctactus" className="mx-auto w-5/6 pt-24 pb-32">
          ...
          >
            ...
            {errors.name && (
              <p className="mt-1 text-primary-500">
                {errors.name.type === "required" && "This field is requered."}
                {errors.name.type === "maxLength" &&
                  "Max length is 100 chareacter."}
              </p>
            )}
            <input
              className={inputStyles}
            ...
            {errors.email && (
              <p className="mt-1 text-primary-500">
                {errors.email.type === "required" && "This field is requered."}
